...
import { bgColors, tableData } from "../../../../utils/common.constants.ts";
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 w-full gap-2 items-center">
            <div className="flex gap-2 items-center">
              <div className="min-w-5">{element.coalfield.number}</div>
            ...
            <div className="text-[#666666]">{element.coalfield.coName}</div>
          </div>
        </div>
      </Table.Td>
