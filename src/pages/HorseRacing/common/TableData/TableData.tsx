      ...
      <div className="space-y-8">
        {data.map((ele, index) => {
          return (
            <div
              key={index}
              className="border-t-1 border-b-1 border-[#E2E2E2] rounded-xl overflow-auto w-full max-w-4xl mx-auto"
            >
                  ...
                  <Table.Tr>
                    <Table.Th className="!font-normal border border-[#E2E2E2]">
                      <div className="font-normal">
                        <div>
                          <strong>Caulfield - Race 1</strong> Avenel Equine
                          Hospital VOBIS Gold Distaff
                        </div>
